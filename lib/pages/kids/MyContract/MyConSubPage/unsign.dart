            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                child: ListTile(
                  ...
                  onTap: ()async{
                    DocumentSnapshot snap = await FirebaseFirestore.instance.collection("user").doc(anotherEmail1).collection("contract").doc(data['contractname']).get();
...
void Show_data1(BuildContext context, Map<String, dynamic>data, String email, String time) => Navigator.of(context)
    .push(MaterialPageRoute(builder: (context) => WaitUpload(data: data, email: email, time: time)));
